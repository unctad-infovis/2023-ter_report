...
function LineChart({
  allow_decimals = false, data, idx, line_width = 5, note = false, show_first_label = true, source, subtitle = false, suffix = '', title, ymax = [undefined, undefined], ymin = [undefined, undefined]
}) {
